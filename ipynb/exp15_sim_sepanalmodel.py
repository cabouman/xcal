...
if __name__ == '__main__':  
    ...
    fltr_params = [
        ...
        {'formula': 'air', 'density': 0, 'thickness_list': [0]},
    ]
    ...
    scint_params = [
        ...
        {'formula': 'Gd3Al2Ga3O12', 'density': 6.63,
         'thickness_list': neg_log_space(vmin=0.02, vmax=0.35, num=10, scale=1)},
    ...
    for rand_seed_num in [81]:
        ...
        axs[1, 1].legend()
        print('\nFinished!\n')
        plt.savefig('./output_exp15/%s_gt.png' % filename)
        ...
        plt.legend()
        plt.ylim((0,1))
        plt.savefig('./output_exp15/%s_proj.png' % (filename))
        ...
        res = xspec.parallel_anal_sep_model(num_threads,
            ...
            learning_rate=1e-1, iterations=1000, tolerance=1e-4, return_history=False)

        np.save('./output_exp15/exp2_res_rdsd%d.npy' % (rand_seed_num), res)
